...
Streaming2::Streaming2(const Dataset &d) : Algorithm(d)
{
}
...
double Streaming2::get_solutions(Seed &seed)
{
    ...
    spdlog::info("Start STREAMING 2: current obj {}", current_obj);
...
// #pragma omp parallel for
        ...
        int const sel_k = std::max_element(w_k.begin(), w_k.end()) - w_k.begin();
        if (w_k[sel_k] < 0)
        {
    ...
    spdlog::info("End STREAMING 2: obj {}", current_obj);
    return current_obj;
}